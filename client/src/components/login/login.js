            ...
            <div className="login-container">
                    ...
                    <form name="form" onSubmit={this.handleSubmit}>
                        <div className={'form-group' + (submitted && !username ? ' has-error' : '')}>
                            ...
                            <input type="text" className="form-control" name="username" value={username} onChange={this.handleChange} placeholder='test...' />
                            {submitted && !username &&
                        ...
                        <div className="form-group">
                            <button className="button" disabled={loading}><span>Login</span></button>
                            {loading &&
